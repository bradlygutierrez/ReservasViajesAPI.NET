    ...
    public class ViajesController : ControllerBase
    {
            ...
            var viajes = await query
                .Select(v => new
                {
                    ...
                    Destino = v.Destino == null ? null : new
                    {
                        ...
                        Pais = v.Destino.Ciudad == null || v.Destino.Ciudad.Pais == null ? null : v.Destino.Ciudad.Pais.Nombre
                    },
                    v.Titulo,
                    v.Descripcion,
                    v.Precio,
        ...
        public async Task<IActionResult> CrearViaje([FromBody] CrearViajeDto dto)
        {
            ...
            var viajeDuplicado = await _context.Viajes
                .AnyAsync(v =>
                    v.Titulo == titulo &&
                    v.TipoViajeId == dto.TipoViajeId &&
                    v.DestinoId == dto.DestinoId);
        ...
        public async Task<IActionResult> DeleteViaje(int viajeId)
        {
            ...
            var tieneDisponibilidades = await _context.Disponibilidades
                .AnyAsync(d => d.ViajeId == viajeId);
